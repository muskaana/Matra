...
export const HalfRangoliPattern = ({ className = "", color = "#ff9930", side = "left" }) => (
  <svg 
    className={className}
    viewBox="0 0 100 100" 
    fill="none" 
  ...
  >
    <defs>
      <clipPath id={`half-clip-${side}`}>
        {side === "left" && <rect x="0" y="0" width="50" height="100" />}
        {side === "right" && <rect x="50" y="0" width="50" height="100" />}
        {side === "top" && <rect x="0" y="0" width="100" height="50" />}
        {side === "bottom" && <rect x="0" y="50" width="100" height="50" />}
      </clipPath>
    </defs>
    <g clipPath={`url(#half-clip-${side})`}>
      <circle cx="50" cy="50" r="3" fill={color} opacity="0.6"/>
      <circle cx="50" cy="50" r="8" stroke={color} strokeWidth="1" opacity="0.5"/>
      <circle cx="50" cy="50" r="15" stroke={color} strokeWidth="1" opacity="0.4"/>
      <circle cx="50" cy="50" r="22" stroke={color} strokeWidth="1" opacity="0.3"/>
...
export const QuarterRangoliPattern = ({ className = "", color = "#ff9930", corner = "top-left" }) => (
  <svg 
    className={className}
    viewBox="0 0 100 100" 
    fill="none" 
  ...
  >
    <defs>
      <clipPath id={`quarter-clip-${corner}`}>
        {corner === "top-left" && <rect x="0" y="0" width="50" height="50" />}
        {corner === "top-right" && <rect x="50" y="0" width="50" height="50" />}
        {corner === "bottom-left" && <rect x="0" y="50" width="50" height="50" />}
        {corner === "bottom-right" && <rect x="50" y="50" width="50" height="50" />}
      </clipPath>
    </defs>
    <g clipPath={`url(#quarter-clip-${corner})`}>
      <circle cx="50" cy="50" r="3" fill={color} opacity="0.6"/>
      <circle cx="50" cy="50" r="8" stroke={color} strokeWidth="1" opacity="0.5"/>
      <circle cx="50" cy="50" r="15" stroke={color} strokeWidth="1" opacity="0.4"/>
      <circle cx="50" cy="50" r="22" stroke={color} strokeWidth="1" opacity="0.3"/>
