/**
 * AdvancedFlashcardPage Component
 * 
 * Flashcard-style learning for advanced word packs
...
export default function AdvancedFlashcardPage() {
  ...
  const handleNext = () => {
    if (isLastCard) {
      // Go to quiz
      setLocation(`/words/advanced/${packId}/quiz`);
    } else {
    ...
    <div className="h-screen bg-gradient-to-b from-orange-50 to-white flex flex-col">
      <div className="w-full max-w-md mx-auto flex flex-col h-full px-4 py-4">
        ...
        <div className="flex items-center justify-between mb-4 flex-shrink-0">
          <button 
            onClick={() => setLocation('/words/advanced')} 
