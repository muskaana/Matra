...
const flows: Flow[] = [
  {
    id: 'landing-to-script',
    name: 'Landing → Script Dashboard',
    steps: [
      { type: 'navigate', href: '/', description: 'Navigate to landing page' },
      { type: 'wait', delay: 500, description: 'Wait for page load' },
      { type: 'click', testId: 'button-start-learning', description: 'Click Start Learning button' },
      { type: 'wait', delay: 500, description: 'Wait for navigation' },
    ],
    expectedEndPath: '/script',
  },
  {
    id: 'landing-to-vowels-lesson',
    name: 'Landing → Script → Vowels Lesson',
    steps: [
      { type: 'navigate', href: '/', description: 'Navigate to landing page' },
      { type: 'wait', delay: 500, description: 'Wait for page load' },
      { type: 'navigate', href: '/script/lesson/vowels/1', description: 'Navigate directly to Vowels lesson 1' },
      { type: 'wait', delay: 500, description: 'Wait for lesson page' },
    ],
    expectedEndPath: '/script/lesson/vowels/1',
  },
  {
    id: 'landing-to-beginner-words',
    name: 'Landing → Beginner Words',
    steps: [
      { type: 'navigate', href: '/', description: 'Navigate to landing page' },
      { type: 'wait', delay: 500, description: 'Wait for page load' },
  ...
  {
    id: 'script-to-read-story',
    name: 'Script → Read Tab → First Story',
    steps: [
      { type: 'navigate', href: '/script', description: 'Navigate to Script page' },
      { type: 'wait', delay: 500, description: 'Wait for page load' },
      { type: 'click', testId: 'button-nav-read', description: 'Click Read tab' },
  ...
  {
    id: 'script-to-talk',
    name: 'Script → Talk Tab',
    steps: [
      { type: 'navigate', href: '/script', description: 'Navigate to Script page' },
      { type: 'wait', delay: 500, description: 'Wait for page load' },
      { type: 'click', testId: 'button-nav-talk', description: 'Click Talk tab' },
