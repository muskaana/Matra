...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col">
      <div className="w-full max-w-sm mx-auto flex-1 flex flex-col p-4 pt-8">
        <h1 className="text-3xl font-bold text-gray-800 mb-10 text-center">Matra</h1>
        
        <div className="space-y-4 flex-1">
          <Link href="/reading">
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow cursor-pointer border-l-4 border-[#ff9930]">
