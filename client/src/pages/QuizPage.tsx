...
const quizData: Record<string, any> = {
  ...
  "c2b": {
    ...
    char1: "ग",
    char2: "घ",
    subQuestion: "Which sound is घ?",
    type: "sound",
    options: [
      { text: "ga", correct: false },
      { text: "gha", correct: true },
    ],
    pageNumber: "Quiz C2b",
    nextLesson: "/script/consonants/sections",
  },
  ...
  "c3b": {
    ...
    char1: "च",
    char2: "छ",
    subQuestion: "Which sound is छ?",
    type: "sound",
    options: [
      { text: "cha", correct: false },
      { text: "chha", correct: true },
    ],
    pageNumber: "Quiz C3b",
    nextLesson: "/script/consonants/sections",
  },
  ...
  "c4b": {
    ...
    char1: "ज",
    char2: "झ",
    subQuestion: "Which sound is झ?",
    type: "sound",
    options: [
      { text: "ja", correct: false },
      { text: "jha", correct: true },
    ],
    pageNumber: "Quiz C4b",
    nextLesson: "/script/consonants/sections",
  },
  ...
  "c5b": {
    ...
    char1: "ट",
    char2: "ठ",
    subQuestion: "Which sound is ठ?",
    type: "sound",
    options: [
      { text: "ṭa", correct: false },
      { text: "ṭha", correct: true },
    ],
    pageNumber: "Quiz C5b",
    nextLesson: "/script/consonants/sections",
  },
  ...
  "c6b": {
    ...
    char1: "ड",
    char2: "ढ",
    subQuestion: "Which sound is ढ?",
    type: "sound",
    options: [
      { text: "ḍa", correct: false },
      { text: "ḍha", correct: true },
    ],
    pageNumber: "Quiz C6b",
    nextLesson: "/script/consonants/sections",
  },
  ...
  "c7b": {
    ...
    char1: "त",
    char2: "थ",
    subQuestion: "Which sound is थ?",
    type: "sound",
    options: [
      { text: "ta", correct: false },
      { text: "tha", correct: true },
    ],
    pageNumber: "Quiz C7b",
    nextLesson: "/script/consonants/sections",
  },
  ...
  "c8b": {
    ...
    char1: "द",
    char2: "ध",
    subQuestion: "Which sound is ध?",
    type: "sound",
    options: [
      { text: "da", correct: false },
      { text: "dha", correct: true },
    ],
    pageNumber: "Quiz C8b",
    nextLesson: "/script/consonants/sections",
  },
  ...
  "c9b": {
    ...
    char1: "प",
    char2: "फ",
    subQuestion: "Which sound is फ?",
    type: "sound",
    options: [
      { text: "pa", correct: false },
      { text: "pha", correct: true },
    ],
    pageNumber: "Quiz C9b",
    nextLesson: "/script/consonants/sections",
  },
  ...
  "c10b": {
    ...
    char1: "ब",
    char2: "भ",
    subQuestion: "Which sound is भ?",
    type: "sound",
    options: [
      { text: "ba", correct: false },
      { text: "bha", correct: true },
    ],
  ...
  "c14b": {
    ...
    char1: "श",
    char2: "ष",
    subQuestion: "Which sound is ष?",
    type: "sound",
    options: [
      { text: "sha", correct: false },
      { text: "ṣa", correct: true },
    ],
  ...
  "c16b": {
    ...
    char1: "त्र",
    char2: "ज्ञ",
    subQuestion: "Which sound is ज्ञ?",
    type: "sound",
    options: [
      { text: "kṣa", correct: false },
      { text: "tra", correct: false },
