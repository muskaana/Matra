...
const quizData: Record<string, any> = {
  ...
  "m6d": {
    ...
    char1: "◌ृ",
    char2: "◌ः",
    subQuestion: "Which words use the visarga 'h' sound? (Select all)",
    type: "word",
    options: [
      { hindi: "दुःख", transliteration: "Dukh", correct: true },
  ...
  "m7c": {
    ...
    char1: "◌ं",
    char2: "◌ँ",
    subQuestion: "Which syllable makes the sound 'kan' (with anusvara)?",
    type: "sound",
    options: [
      { text: "कं", correct: true },
  ...
  "m7d": {
    ...
    char1: "◌ं",
    char2: "◌ँ",
    subQuestion: "Which words use the nasalized vowel (chandrabindu)? (Select all)",
    type: "word",
    options: [
      { hindi: "अँधेरा", transliteration: "Andhera", correct: true },
      { hindi: "साँप", transliteration: "Saap", correct: true },
      { hindi: "संगीत", transliteration: "Sangeet", correct: false },
      { hindi: "अंगूर", transliteration: "Angoor", correct: false },
    ],
    pageNumber: "Quiz M7d",
    nextLesson: "/script/matra/sections",
  },
