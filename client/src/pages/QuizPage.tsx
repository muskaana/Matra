...
const quizData: Record<string, any> = {
  ...
  "m1c": {
    ...
    options: [
      ...
      { text: "Naam (नाम)", correct: true },
      { text: "Kab (कब)", correct: false },
      { text: "Ghar (घर)", correct: false },
    ],
    pageNumber: "Quiz M1c",
    nextLesson: "m1d",
  },
  ...
  "m2a": {
    ...
    char1: "◌ि",
    char2: "◌ी",
    subQuestion: "What is ◌ि (short i)?",
    type: "sound",
    options: [
      { text: "i (short)", correct: true },
      { text: "ee (long)", correct: false },
    ],
    pageNumber: "Quiz M2a",
    nextLesson: "m2b",
  },
  "m2b": {
    ...
    char1: "◌ि",
    char2: "◌ी",
    subQuestion: "What is ◌ी (long i)?",
    type: "sound",
    options: [
      { text: "i (short)", correct: false },
      { text: "ee (long)", correct: true },
    ],
    pageNumber: "Quiz M2b",
    nextLesson: "m2c",
  },
  "m2c": {
    ...
    char1: "◌ि",
    char2: "◌ी",
    subQuestion: "Which syllable makes the sound 'ki' (short)?",
    type: "sound",
    options: [
  ...
  "m2d": {
    ...
    options: [
      ...
      { text: "Deep (दीप)", correct: true },
      { text: "Mithai (मिठाई)", correct: false },
      { text: "Dil (दिल)", correct: false },
    ],
    pageNumber: "Quiz M2d",
    nextLesson: "/script/matra/sections",
  },
  "m3a": {
    ...
    char1: "◌ु",
    char2: "◌ू",
    subQuestion: "What is ◌ु (short u)?",
    type: "sound",
    options: [
      { text: "u (short)", correct: true },
      { text: "oo (long)", correct: false },
    ],
    pageNumber: "Quiz M3a",
    nextLesson: "m3b",
  },
  "m3b": {
    ...
    char1: "◌ु",
    char2: "◌ू",
    subQuestion: "What is ◌ू (long u)?",
    type: "sound",
    options: [
      { text: "u (short)", correct: false },
      { text: "oo (long)", correct: true },
    ],
    pageNumber: "Quiz M3b",
    nextLesson: "m3c",
  },
  "m3c": {
    ...
    char1: "◌ु",
    char2: "◌ू",
    subQuestion: "Which syllable makes the sound 'ku' (short)?",
    type: "sound",
    options: [
  ...
  "m3d": {
    ...
    options: [
      ...
      { text: "Jhoola (झूला)", correct: true },
      { text: "Kuch (कुछ)", correct: false },
      { text: "Gur (गुड़)", correct: false },
    ],
    pageNumber: "Quiz M3d",
    nextLesson: "/script/matra/sections",
  },
  ...
  "m4d": {
    ...
    options: [
      ...
      { text: "Ainak (ऐनक)", correct: true },
      { text: "Dev (देव)", correct: false },
      { text: "Nail (नेल)", correct: false },
    ],
    pageNumber: "Quiz M4d",
    nextLesson: "/script/matra/sections",
  },
  ...
  "m5d": {
    ...
    options: [
      ...
      { text: "Daud (दौड़)", correct: true },
      { text: "Moti (मोती)", correct: false },
      { text: "Sona (सोना)", correct: false },
    ],
    pageNumber: "Quiz M5d",
    nextLesson: "/script/matra/sections",
  },
  ...
  "m6d": {
    ...
    options: [
      ...
      { text: "Angoor (अंगूर)", correct: true },
      { text: "Kripa (कृपा)", correct: false },
    ],
    pageNumber: "Quiz M6d",
    nextLesson: "/script/matra/sections",
  },
  ...
  "m7d": {
    ...
    options: [
      ...
      { text: "Saap (साँप)", correct: true },
      { text: "Dukh (दुःख)", correct: false },
    ],
    pageNumber: "Quiz M7d",
    nextLesson: "/script/matra/sections",
  },
