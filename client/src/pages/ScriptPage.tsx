...
export default function ScriptPage() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      <div className="w-full max-w-sm mx-auto flex-1 flex flex-col p-6 py-8">
        <div className="flex-1 flex flex-col">
          <div className="bg-[#ff9930] text-white px-5 py-4 rounded-t-lg font-semibold text-lg">
            Hindi (Devanagari) Script
          </div>
          
          <div className="bg-white p-6 rounded-b-lg shadow-md flex-1 border-x border-b border-gray-200">
            <div className="space-y-5">
              {levels.map((level, index) => (
                <Link key={level.id} href={level.href || "#"}>
                  <div className="flex items-center gap-4 cursor-pointer group py-1">
