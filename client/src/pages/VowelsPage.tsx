...
export default function VowelsPage() {
  ...
  const lessons = [
    ...
    { id: 2, title: "Consonants", href: `/script/consonants/sections`, icon: "क", progress: consonantsProgress, locked: !isVowelsComplete, lockReason: "Complete all Vowels first" },
    { id: 3, title: "Matra (Vowel Symbols)", href: `/script/matra/sections`, icon: "ा", progress: matraProgress, locked: !isConsonantsComplete, lockReason: "Complete all Consonants first" },
